...
const uploadStepMeta: Array<{
  ...
  { key: 'validated', label: '유효성 검증', detail: '방영일 및 중복 회차 체크' },
  { key: 'reviewed', label: '최종 리뷰', detail: '오탈자 및 에러 수정' },
  { key: 'saved', label: 'DB 저장', detail: '리뷰 사이트 반영 완료' },
]
...
const caseStudyCards = [
  {
    title: '문제',
    body:
      '중국 드라마는 보통 30~50부작에 달해 회차 정보를 하나씩 입력하면 실수가 잦고 시간이 오래 걸린다. 특히 방영 일정이 유동적이어서 일괄 수정 도구가 필요했다.',
  },
  {
    title: '운영 전략',
    body:
      '엑셀 대량 업로드를 통해 1화부터 최종화까지의 모든 메타데이터(부제, 줄거리, 러닝타임)를 한 번에 검증하고 리뷰할 수 있는 파이프라인을 구축했다.',
  },
  {
    title: '도메인 특화',
    body:
      '중국 현지 방영일과 국내 스트리밍 일정이 다른 점을 고려하여, 플랫폼별 방영 정보를 구분하여 업로드할 수 있도록 설계했다.',
  },
]
...
const outcomeCards = [
  {
    title: '운영 생산성',
    body:
      '수십 개의 에피소드 정보를 수기로 입력하던 방식 대비 업무 속도를 90% 이상 개선했다.',
  },
  {
    title: '데이터 정합성',
    body:
      '회차 중복이나 줄거리 누락 등을 저장 전에 차단하여 사용자에게 정확한 정보를 제공한다.',
  },
  {
    title: '유연한 일정 관리',
    body:
      '결방이나 일정 변경 시 엑셀 수정 후 재업로드만으로 전체 회차 정보를 즉시 갱신할 수 있다.',
  },
]
