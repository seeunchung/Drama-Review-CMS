...
export const CommentGrid: React.FC<Props> = ({ comments, selectedId, onSelect }) => {
  return (
    <div className="panel curation-comment-grid">
      <div className="curation-grid-header">
        <div>회차</div>
        <div>작성자</div>
        <div>내용</div>
        <div>별점</div>
      ...
      <div className="curation-grid-body">
        {comments.map(comment => (
          <div 
            key={comment.id}
            className={`curation-comment-row 
          ...
          >
            ...
            <div className="curation-cell-content">{comment.user_nickname}</div>
            <div className="curation-cell-content">{comment.content}</div>
            <div className="curation-rating-stars">{"★".repeat(comment.rating)}</div>
            <div>
